...
;
; Lowest system claim: MAINK at $AC00, in main.asm.
; System storage spans $AC00-$AE69, 618 bytes claimed.
;
...
; ---------------------------------------------------------------------
SYSBOT  = $9800                 ; the first byte not a program's
USERTOP = $97FF                 ; the last byte a program may use
SCREEN  = $9800                 ; the text map, 5120 bytes
