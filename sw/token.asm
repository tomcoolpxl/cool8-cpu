...
LBUF    = $B433                 ;: 128 the line being worked on, as text
LLEN    = $B4B3                 ;: 1 how much of it there is
TBUF    = $B4B4                 ;: 128 the same line, tokenised
TLEN    = $B534                 ;: 1 and how long that came out
TOKI    = $B535                 ;: 1 how far along the text the scan is
TOKQ    = $B536                 ;: 1 inside a quoted string
