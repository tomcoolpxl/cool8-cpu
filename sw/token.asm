...
LBUF    = $7CA9                 ;: 128 the line being worked on, as text
LLEN    = $7D29                 ;: 1 how much of it there is
TBUF    = $7D2A                 ;: 128 the same line, tokenised
TLEN    = $7DAA                 ;: 1 and how long that came out
TOKI    = $7DAB                 ;: 1 how far along the text the scan is
TOKQ    = $7DAC                 ;: 1 inside a quoted string
