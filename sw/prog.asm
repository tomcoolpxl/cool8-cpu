...
PROGEND = $AC31                 ;: 2 first free byte above it
...
; ---------------------------------------------------------------------
PRGW    = $AC2B                 ;: 6 the top-level commands' scratch
...
vclear: MOV  R0,#<USERTOP
        ...
        CLR  R0
        ST   [NNAME],R0
        ST   [LDEPTH],R0        ; and nothing is saved -- without this
        RET                     ;   it started as whatever was there
