...
MOTT_VOL = 9                  # MOTT's program and theme files; its loader is on the CoolAction disc
...
CLAIMED = {BOOT_VOL, USER_VOL, MOTT_VOL, PICTURE_VOL, ACTION_VOL, DEMO_VOL, SOFTWARE_VOL, PASCAL_VOL}
