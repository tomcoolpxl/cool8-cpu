...
// rather than within the map, so the map slides with the scroll instead
// of rotating inside it -- every row of the screen reads from the wrong
// address the moment anything scrolls, at ANY stride. `sim/test_vm.py`
